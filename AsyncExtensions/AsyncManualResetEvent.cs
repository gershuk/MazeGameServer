...
namespace AsyncExtensions
{
    public class AsyncManualResetEvent
    {
        ...
        public bool WaitAsyncCalled => _completionWrapper.WaitAsyncCalled;

        public void Set () => _completionWrapper.Tcs.TrySetResult(true);
        ...
        public void Reset ()
        {
            ...
            {
                var wrapper = _completionWrapper;
                if (!wrapper.Tcs.Task.IsCompleted || Interlocked.CompareExchange(ref _completionWrapper, new CompletionWrapper(), wrapper) == wrapper)
                    return;
            }
        }
